...
-- CreateIndex
CREATE INDEX "Appointment_status_starTime_idx" ON "public"."Appointment"("status", "starTime");

-- CreateIndex
CREATE INDEX "Appointment_doctorId_starTime_idx" ON "public"."Appointment"("doctorId", "starTime");
