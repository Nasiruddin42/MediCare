...
const PendingDoctors: React.FC<PendingDoctorsProps> = ({ doctors }) => {
 ...
 ;
  ...
  const handleUpdateStatus = async (doctorId: string | Blob, status: string | Blob) => {
    if (loading) return;
  ...
  useEffect(() => {
  if (data && "success" in data && (data as any).success) {
    handleCloseDialog();
  }
}, [data]);
                        ...
                        <CardContent className='p-4'>
                           <div className='flex flex-col md: flex-row md: items-center justify-between gap-4'>
                              <div>
                                 ...
                                 <div>
                                    <h3 className='font-medium text-white mb-1 mt-2' >
                                       {doctor.name}
                                    </h3>
                                    <p>
