...
const AvailabilitySettings = ({ slots }: AvailabilitySettingsProps) => {
  ...
  function createLocalDateFromTime(timeStr: any) {
...
// Format time string for display
  const formatTimeString = (dateString: string | number | Date) => {
    try {
